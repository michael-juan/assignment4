...
/* I implemented the priority queue in such a way that it removes from the end which will always be on the left, and add to the beginning, which will always be on the right. */
...
{
/* for this enqueue function, I received help from Art on May 30th during the night lab session */
